...
export function Footer() {
  return (
    <div className="d-flex footerContainer px-4 px-md-5">
      <div id='contactContainer' className="col-12 col-md-4 my-2 ">
        <h4 className='text-start'><b>Contáctanos:</b></h4>
        <ListGroup.Item className='d-flex'><BsEnvelope /><p className='mx-2 my-0'><b>Email:</b> gmail@codeschool.com</p></ListGroup.Item>
      ...
      <div id='logoContainer' className="col-12 col-md-4 d-flex align-items-center justify-content-center">
        <img className="logo" src={Logo} width="245px" alt="Code School logo" />
      </div>
      <div id='socialMediaContainer' className="col-12 col-md-4 d-flex align-items-center justify-content-end">
