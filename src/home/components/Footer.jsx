  ...
  return (
    <div className="d-flex footerContainer px-4 px-md-5">
      <div id='contactContainer' className="col-12 col-md-6 col-lg-4 my-2 ">
        ...
        <ListGroup.Item className='iconFooter d-md-flex'><BsEnvelope /><p className='textContactFooter mx-2 my-0'><b>Email:</b> gmail@codeschool.com</p></ListGroup.Item>
        <ListGroup.Item className='iconFooter d-md-flex'><BsPinMap /><p className='textContactFooter mx-2 my-0'><b>Dirección:</b> Av. Aconquija 1125</p></ListGroup.Item>
